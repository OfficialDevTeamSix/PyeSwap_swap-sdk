...
var FACTORY_ADDRESS = (_FACTORY_ADDRESS = {}, _FACTORY_ADDRESS[ChainId.MAINNET] = "0xBCfCcbde45cE874adCB698cC183deBcF17952812", _FACTORY_ADDRESS[ChainId.TESTNET] = "0x0eDbD414FD32975Da2A5f0947f3Fe3717D71B117", _FACTORY_ADDRESS);
var INIT_CODE_HASH = (_INIT_CODE_HASH = {}, _INIT_CODE_HASH[ChainId.MAINNET] = "0xd0d4c4cd0848c93cb4fd1f498d7013ee6bfb25783ea21593d5834f5d250ece66", _INIT_CODE_HASH[ChainId.TESTNET] = '0xbdf9d98be029040bc32e3729b387e1e2fe88bb4e5b81a9f79bac244872156b6f', _INIT_CODE_HASH);
    ...
    try {
      ...
      return Promise.resolve(new Contract(address, IPYESwapPair.abi, provider).getReserves()).then(function (_ref) {
        var reserves0 = _ref[0],
            reserves1 = _ref[1];
        return Promise.resolve(new Contract(address, IPYESwapPair.abi, provider).baseToken()).then(function (baseToken) {
